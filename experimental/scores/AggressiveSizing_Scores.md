...
**Source:** `experimental/AggressiveSizing.py`
...
2. AthenaBot: $-0.32
AthenaBot bankrupt: False (cash balance: 9.68, starting capital: 10.0)
...
> AthenaBot quoted buy 0.08 for 10 / sell 9 @ 0.14 (theo=0.1065)
> AthenaBot bought 0.08 for 6 8734500 (1d THR >= 2371.00) (counterparty 689497)
> RFQ from counterparty 689497: buy 2 8734500 (1d THR >= 2371.00)
> AthenaBot quoted buy 0.02 for 4 / sell 6 @ 0.08 (theo=0.1065)
> AthenaBot sold 2 @ 0.08 8734500 (1d THR >= 2371.00) (counterparty 689497)
...
AthenaBot bankrupt: False (cash balance: 20.72, starting capital: 20.0)
...
> AthenaBot quoted buy 0.09 for 10 / sell 10 @ 0.24 (theo=0.1666)
> AthenaBot sold 3 @ 0.24 3857985 (1d FED >= 1.75) (counterparty 309546)
...
> AthenaBot quoted buy 0.97 for 10 / sell 10 @ 1.0 (theo=1.0000)
...
2. Mongoose: $0.3
3. AthenaBot: $-3.76
AthenaBot bankrupt: False (cash balance: 36.24, starting capital: 40.0)
...
> AthenaBot quoted buy 0.67 for 10 / sell 10 @ 0.76 (theo=0.7104)
...
```
Ranking:
1. Stalemate Quoter: $12.0
2. AthenaBot: $8.74
AthenaBot bankrupt: False (cash balance: 18.74, starting capital: 10.0)
...
```
Ranking:
1. Fixed Width 0.25: $29.43
2. AthenaBot: $-6.48
AthenaBot bankrupt: False (cash balance: 3.52, starting capital: 10.0)
Result: PASS (score=0.40)
```
...
```
Ranking:
1. Fixed Width 0.1: $34.04
2. AthenaBot: $2.54
3. Stalemate Quoter: $2.0
AthenaBot bankrupt: False (cash balance: 12.54, starting capital: 10.0)
...
Ranking:
1. AthenaBot: $23.53
2. Fixed Width 0.1: $21.14
3. Fixed Width 0.25: $-0.57
AthenaBot bankrupt: False (cash balance: 33.53, starting capital: 10.0)
Result: PASS (score=1.00)
```
...
```
Ranking:
1. Fixed Width 0.1: $50.03
2. Stalemate Quoter: $5.0
3. AthenaBot: $-2.77
AthenaBot bankrupt: False (cash balance: 17.23, starting capital: 20.0)
Result: PASS (score=0.40)
```
...
3. Fixed Width 0.05: $-21.2
AthenaBot bankrupt: False (cash balance: 42.82, starting capital: 20.0)
Result: PASS (score=1.00)
```
...
Ranking:
1. AthenaBot: $12.04
2. Fixed Width 0.05: $-11.63
AthenaBot bankrupt: False (cash balance: 32.04, starting capital: 20.0)
Result: PASS (score=1.00)
```
...
1. Lattice: $14.29
2. AthenaBot: $11.04
3. Fixed Width 0.1: $3.74
4. Situational Unawareness: $2.74
AthenaBot bankrupt: False (cash balance: 31.04, starting capital: 20.0)
...
Ranking:
1. Lattice: $23.33
2. Fixed Width 0.05: $13.44
3. AthenaBot: $2.07
AthenaBot bankrupt: False (cash balance: 22.07, starting capital: 20.0)
Result: PASS (score=0.40)
```
...
Ranking:
1. AthenaBot: $63.49
2. Situational Unawareness: $1.88
3. Lattice: $0.69
AthenaBot bankrupt: False (cash balance: 83.49, starting capital: 20.0)
Result: PASS (score=1.00)
```
...
Ranking:
1. AthenaBot: $73.64
2. Fixed Width 0.05: $5.56
3. Lattice: $4.32
AthenaBot bankrupt: False (cash balance: 113.64, starting capital: 40.0)
Result: PASS (score=1.00)
```
...
Ranking:
1. AthenaBot: $39.45
2. Situational Unawareness: $12.69
3. Lattice: $1.47
4. Mongoose: $-6.71
AthenaBot bankrupt: False (cash balance: 79.45, starting capital: 40.0)
Result: PASS (score=1.00)
```
...
```
Ranking:
1. Fixed Width 0.05: $30.09
2. Lattice: $4.3
3. Mongoose: $-5.93
4. AthenaBot: $-18.98
AthenaBot bankrupt: False (cash balance: 21.02, starting capital: 40.0)
Result: PASS (score=0.40)
```
...
```
Ranking:
1. Situational Unawareness: $19.14
2. AthenaBot: $-10.0
3. Mongoose: $-13.32
4. Fixed Width 0.05: $-32.32
AthenaBot bankrupt: False (cash balance: 30.0, starting capital: 40.0)
Result: PASS (score=0.80)
```
...
2. Lattice: $-21.86
3. Mongoose: $-32.5
4. Fixed Width 0.05: $-87.15
AthenaBot bankrupt: False (cash balance: 33.03, starting capital: 40.0)
Result: PASS (score=1.00)
```
...
| 3 | VERBOSE 2 | PASS | 1.00 | False | **#1 of 3** |
...
**SCORED subtotal: 11.70/16 points (~73%).** No bankruptcies and no errors across all 20 test cases. AthenaBot ranks #1 outright in 7 of 16 SCORED sessions.
...
| SCORED (Tests 5-20) | 11.70 | 16 |
| **Total** | **15.70** | **20** |

**15.70/20 (78.5%)** overall.
