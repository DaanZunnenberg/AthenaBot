...
# --- Lineage ----------------------------------------------------------------
# Adds: adds a _FlowRegime tracker that narrows spreads on favorable post-trade markouts.
...
class MarketMaker:
    ...
    def _mid_and_spreads(self, option, counterparty_id):
        ...
        h_bid = max(0.005, base_h + skew_bid + t_b - tighten)
        h_ask = max(0.005, base_h + skew_ask + t_a - tighten)
